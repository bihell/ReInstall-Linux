...
d-i pkgsel/include string openssh-server lrzsz net-tools rsync socat curl sudo wget telnet iptables gpg zsh python3 pip nmap tree iperf3 vnstat iptables-persistent traceroute iostat
